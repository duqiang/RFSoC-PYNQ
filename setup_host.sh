...
if [ $(lsb_release -rs) == "20.04" ]; then
    rel_deps="libncurses6 lib32ncurses6 libncurses-dev"
else
    echo "Error: Please use Ubuntu 20.04."
    exit 1
fi
...
echo 'source /opt/xilinx_2022.1/Vitis/2022.1/settings64.sh' >> ~/.profile
echo 'source /opt/xilinx_2022.1/PetaLinux/2022.1/settings.sh' >> ~/.profile
